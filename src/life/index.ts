// import { addListeners, calcNumPages, rgb2bgr } from './utils';
// import { Exported } from './types';
// import { RGB_ALIVE, RGB_DEAD, BIT_ROT, WASM_FILENAME, HEIGHT, WIDTH } from './common/constants';

import { HEIGHT, WIDTH } from './common/constants';
import { calcNumPages } from './utils';
...
`;
  ...
  // });
  console.log(calcNumPages(500, 500));
  //   try {
